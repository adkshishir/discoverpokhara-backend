...
<div class="container h-full w-full">
    <div class="container pt-5 rounded ">
        <form class="pt-5 rounded form bg-white p-3" enctype="multipart/form-data" action="{{ route('categories.store') }}" method="POST">
            @csrf
            <h3>SEO</h3>`
            <div class="row">
                   <div class="col-md-6">
                ...
                <div class="col-md-12">
                  ...
                  @endphp
                 <x-adminlte-textarea name="schema" rows="7" label="Schema" value="{{old('schema')}}" placeholder="Write Schema..."/>
            ...
            <div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <div>
                        ...
                        <input class="form-control form-control-lg" id="image" type="file" value="{{ old('image') }}" name="image">
                      </div>
