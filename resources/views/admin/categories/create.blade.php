...
<form id="form" class="pt-5 rounded form bg-white p-3" enctype="multipart/form-data"
            ...
            <div class="row">
<div class="col-md-6">
<x-adminlte-input id="meta_title" value="{{ old('meta_title') }}" name="meta_title" label="Meta Title"
...
<div id="meta_description_error" class="text-danger">{{ $errors->first('meta_description')
                                }}</div>
                            @endif
                        </x-slot> --}}
</x-adminlte-input>
...
<x-adminlte-textarea id="schema" name="schema" rows='7' class="form-control" label="schema"
            ...
            <div class="row">
<div class="col-md-6">
<x-adminlte-input value="{{ old('title') }}" name="title" label="Title" placeholder="Enter Title" fgroup-class="">
...
<x-adminlte-input value="{{ old('slug') }}" name="slug" label="Slug" placeholder="Slug..." fgroup-class="" />
                ...
                <div class="col-md-12">
<x-adminlte-textarea id="description" name="description" rows="4" label="description" placeholder="Write Schema...">
                        {{old('description')}}</x-adminlte-textarea>
...
<x-adminlte-button id="submit-button" {{-- onclick="return validateForm()" --}} class="btn-flat  mt-4" type="submit"
                label="Submit" theme="success" icon="fas fa-lg fa-save " />
        </form>
    </div>
</div>
@endsection
